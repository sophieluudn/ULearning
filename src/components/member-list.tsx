              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3 max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center justify-center">
                      <div className="text-sm text-gray-500 w-32 text-right pr-4">交易紀錄</div>
                      <div className="flex-1"><a href="#" className="text-sm hover:underline" style={{ color: '#409eff' }}>按此另開視窗</a></div>
                    </div>
                    <div className="flex items-center justify-center">
                      <div className="text-sm text-gray-500 w-32 text-right pr-4">訂單管理</div>
                      <div className="flex-1"><a href="#" className="text-sm hover:underline" style={{ color: '#409eff' }}>按此另開視窗</a></div>
                    </div>
                    <div className="flex items-center justify-center">
                      <div className="text-sm text-gray-500 w-32 text-right pr-4">會員資產管理</div>
                      <div className="flex-1"><a href="#" className="text-sm hover:underline" style={{ color: '#409eff' }}>按此另開視窗</a></div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3 max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center justify-center">
                      ...
                      <div className="flex-1"><div className="rounded-full bg-gray-400" style={{ width: '30px', height: '30px' }} /></div>
                    </div>
                    <div className="flex items-center justify-center">
                      <div className="text-sm text-gray-500 w-32 text-right pr-4">e-mail</div>
                  ...
                  {selectedMember.devices.length > 0 ? (
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <Table>
                        <TableHeader>
                          <TableRow className="bg-gray-50 hover:bg-gray-50">
                            <TableHead className="text-center border-r border-gray-200">device ID</TableHead>
                            <TableHead className="text-center border-r border-gray-200">型號</TableHead>
                            <TableHead className="text-center border-r border-gray-200">名稱</TableHead>
                            <TableHead className="text-center border-r border-gray-200">註冊日期</TableHead>
                            <TableHead className="text-center">刪除</TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {selectedMember.devices.map((device) => (
                            <TableRow key={device.deviceId}>
                              <TableCell className="text-center border-r border-gray-200 text-sm">{device.deviceId}</TableCell>
                              <TableCell className="text-center border-r border-gray-200 text-sm">{device.model}</TableCell>
                              <TableCell className="text-center border-r border-gray-200 text-sm">{device.name}</TableCell>
                              <TableCell className="text-center border-r border-gray-200 text-sm whitespace-nowrap">{device.registerDate}</TableCell>
                    ...
                    <div className="text-sm text-gray-500 text-center py-4">無登入裝置記錄</div>
                  )}
                </CardContent>
              </Card>
